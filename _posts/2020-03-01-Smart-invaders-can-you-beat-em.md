...
![figure-1]({{ site.baseurl }}/assets/img/invaders/main-menu.png)
...
Unfortunately, Genetic Algorithms are out of the scope of this post, but if you are interested in quick and intuitive introduction, I recommend you to watch the series made by "The Coding Train". I leave you here the introduction (you can see the rest of this series in his channel):

{% include video id="9zfeTw-uFCw" provider="youtube" %}

For a more formal introduction, you can watch [this nice introduction](https://www.youtube.com/watch?v=kHyNqSnzP8Y) from the MIT's professor Patrick Winston (who sadly passed away in 2019).
...
![figure-2]({{ site.baseurl }}/assets/img/invaders/space_invaders_1978.jpg)
...
{% include video id="ob0b588nq1Q" provider="youtube" %}
...
{% include video id="rGWBo0JGf50" provider="youtube" %}
...
{% include video id="1zZZjaYl4AA" provider="youtube" %}
